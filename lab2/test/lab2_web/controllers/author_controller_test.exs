defmodule Lab2Web.AuthorControllerTest do
  use Lab2Web.ConnCase

  alias Lab2.Authors

  @create_attrs %{birth: "some birth", name: "some name", rating: 42, surname: "some surname"}
  ...
  describe "update author" do
    ...
    test "redirects when data is valid", %{conn: conn, author: author} do
      ...
      assert html_response(conn, 200) =~ "some updated birth"
    end
